...
export const Digitize: React.FC<DigitizeProps> = ({ customers, onImport }) => {
  ...
  return (
    <div className="animate-in fade-in duration-300 pb-safe">
      <div className="mb-6 bg-slate-900 dark:bg-slate-800 rounded-3xl p-6 text-white relative overflow-hidden shadow-xl ring-1 ring-white/10">
        <div className="absolute -right-6 -bottom-10 opacity-10">
            <ScanLine size={140} />
        </div>
        <h2 className="text-2xl font-bold mb-2 relative z-10">Digitalizar</h2>
